...
\begin{tabular}{c|c|c|c|c|c}
	...
	\hline
	\hline
	$L_0$ & Management du projet & MGMT & $38$ & $S_3$ & $S_{20}$ \\
	\hline
	$L_1$ & Étude bibliographique & RECH & $38$ & $S_3$ & $S_5$ \\
	\hline
	$L_2$ & Cahier des charges & REDAC & $38$ & $S_3$ & $S_4$ \\
	\hline
	$L_3$ & Extension pour le typage & IMPL & $38$ & $S_6$ & $S_{12}$ \\
	\hline
	$L_4$ & Formalisation des contraintes & RECH & $38$ & $S_{13}$ & $S_{14}$ \\
	\hline
	$L_5$ & Implémentation des contraintes & IMPL & $38$ & $S_{15}$ & $S_{17}$ \\
	\hline
...
\begin{tabular}{c|c|c|c|c}
	...
	\hline
	$D_4$ & Diaporama de présentation & $1$ & Document & $S_{20}$ \\
\end{tabular}
\end{center}
