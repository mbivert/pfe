...
public final class EntropyBuilder {
     ...
     */
    public static Entropy buildFromProperties(PropertiesHelper props) throws IOException, PropertiesHelperException, MonitorFactoryException, ControlLoopFactoryException, VJobBuilderFactoryBuilderException {
        MonitorFactory mf = new MonitorFactory(props);
        VJobBuilderFactory vjobFac = new VJobBuilderFactoryBuilderFromProperties("config/vjobsBuilder.properties").build();
