...
public class MockDurationEvaluator implements DurationEvaluator {
     ...
     *
     * @param f     the cost of a VM forge
     ...
     */
    public MockDurationEvaluator(int f, int m, int st, int r, int lres, int rres, int su, int start, int shut) {
        this();
        costs[IDX_FORGE] = f;
        costs[IDX_MIGRATE] = m;
        costs[IDX_STOP] = st;
