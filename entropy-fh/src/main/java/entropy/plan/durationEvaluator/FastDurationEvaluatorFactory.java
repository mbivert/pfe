...
public final class FastDurationEvaluatorFactory {
     ...
     *          if the property file does not contains all the required properties
     */
    public static DurationEvaluator readFromProperties(PropertiesHelper props) throws PropertiesHelperException {
        ...
        try {
            return new FastANTLRDurationEvaluator(mig, stop, run, suspend, localResume, remoteResume, startup, shutdown, forge);
