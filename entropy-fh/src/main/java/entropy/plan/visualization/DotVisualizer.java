...
public class DotVisualizer implements PlanVisualizer {
    ...
    public void inject(Instantiate a) {
        ...
        buffer.append(a.getVirtualMachine().getName());
        buffer.append(" [label=\"\", shape=none]\n");
        buffer.append("i").append(a.getVirtualMachine().getName()).append(" -> FORGE");
    ...
    public void inject(Deploy a) {
        buffer.append("[label=\"deploy(").append(a.getNode()).append(',').append(a.getPlatform()).append(")\", color=\"blue\"]\n");
    }

    @Override
    public void inject(VirtualMachineRename a) {
