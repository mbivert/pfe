...
public class Slice {
    ...
    public String pretty() {
        ...
        builder.append(name).append(" cpu=").append(cpuHeight).append(", mem=").append(memHeight)
                .append("{[").append(start().getInf()).append(",");
    ...
    public void addToModel(ReconfigurationProblem core) {
        ...
        } else if (start().isInstantiated() && end().isInstantiated()) {
            try {
                duration().setVal(end().getVal() - start().getVal());
            } catch (ContradictionException e) {
                Plan.logger.error(e.getMessage(), e);
            }
        } else {
    ...
    /**
     * Set the CPU height of the slice.
     *
     * @param cpuHeight the new height
     */
    public void setCpuHeight(int cpuHeight) {
        this.cpuHeight = cpuHeight;
    }

    /**
     * Set the memory height of the slice.
     *
     * @param memHeight the new height
     */
    ...
    /**
     * Get the task associated to the slice.
     *
     * @return a task variable.
     */
    public TaskVar getTask() {
        return task;
    }
}
