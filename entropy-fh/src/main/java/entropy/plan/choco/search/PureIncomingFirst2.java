...
public class PureIncomingFirst2 extends AbstractIntVarSelector {
     ...
     */
    public PureIncomingFirst2(ChocoCustomRP planner, ReconfigurationProblem solver, List<ActionModel> actions) {
        ...
        hoster = new IntDomainVar[vmActions.size()];
        starts = new IntDomainVar[vmActions.size()];
