...
public final class SimpleBinPackingFiltering {
    ...
    /**
     * Redundant method to compute the rload and the cload of each bin.
     * Very bad for performance. These values should be maintained incrementally.
     *
     * @param bin the bin to look up to compute loads
     */
    private void sumEnvelop(int bin) {
