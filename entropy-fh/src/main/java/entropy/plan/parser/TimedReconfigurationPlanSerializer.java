...
public interface TimedReconfigurationPlanSerializer {
    ...
    /**
     * Serialize an instantiate action that is a part of the current serialized plan.
     *
     * @param a the action to serialize
     * @throws IOException if an error occurred while writing to the stream
     */
    ...
    /**
     * Serialize a rename action that is a part of the current serialized plan.
     *
     * @param a the action to serialize
     * @throws IOException if an error occurred while writing to the stream
     */
    void serialize(VirtualMachineRename a) throws IOException;
}
