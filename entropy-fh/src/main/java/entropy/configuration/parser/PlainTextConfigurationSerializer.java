...
public final class PlainTextConfigurationSerializer extends FileConfigurationSerializer {
    ...
    private static VirtualMachine readVirtualMachine(String line) throws ConfigurationSerializerException {
        String[] toks = line.split(FIELD_SEP);
    ...
    private static Node readNode(String line) throws ConfigurationSerializerException {
        String[] toks = line.split(FIELD_SEP);
