 ...
 */
public abstract class FileConfigurationSerializer implements ConfigurationSerializer {
     ...
     */
    public final Configuration read(String path) throws IOException, ConfigurationSerializerException {
