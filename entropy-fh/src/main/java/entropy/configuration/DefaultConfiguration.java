 ...
 * @deprecated use {@link SimpleConfiguration} instead
 */
public class DefaultConfiguration implements Configuration {
    ...
    public boolean addOffline(Node node) {
        ...
        if (this.getRunnings(node).isEmpty()
                && this.getSleepings(node).isEmpty()) {
    ...
    public ManagedElementSet<Node> getUsedNodes() {
        ...
        for (Node n : this.onlines) {
            if (!this.getRunnings(n).isEmpty()) {
                set.add(n);
            }
        }
        return set;
    ...
    public String toString() {
        ...
        for (Node n : onlines) {
            ...
            if (!this.getSleepings(n).isEmpty()) {
        ...
        buf.append("FARM");
        for (VirtualMachine vm : this.waitings) {
            buf.append(" ");
            buf.append(vm.getName());
        }
        buf.append("\n");
    ...
    public boolean equals(Object o) {
        if (o == null) {
            ...
            if (this.runnings.equals(ref.getRunnings())
                    && this.sleepings.equals(ref.getSleepings())
                    && this.waitings.equals(ref.getWaitings())
                    && this.onlines.equals(ref.getOnlines())
                    && this.offlines.equals(ref.getOfflines())
                    ) {
    ...
    public boolean isOnline(Node n) {
        return this.onlines.contains(n);
    }
    ...
    public boolean isOffline(Node n) {
        return this.offlines.contains(n);
    }
    ...
    public boolean isRunning(VirtualMachine vm) {
        return this.runnings.contains(vm);
    }
    ...
    public boolean isWaiting(VirtualMachine vm) {
        return this.waitings.contains(vm);
    }
    ...
    public boolean isSleeping(VirtualMachine vm) {
        return this.sleepings.contains(vm);
    }
    ...
    public boolean contains(VirtualMachine vm) {
        return runnings.contains(vm) || waitings.contains(vm) || sleepings.contains(vm);
    }
}
