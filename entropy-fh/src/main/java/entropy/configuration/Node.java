...
public interface Node extends ManagedElement {
     ...
     *
     * @return the identifier of the currently deployed platform if any. {@code null} otherwise
     */
    String getCurrentPlatform();

    /**
     * Set the current platform on this node.
     * The platform must already be available for this node
     *
     * @param k the identifier of the platform
     * @return {@code true} if the platform has been set,
     *         {@code false} if the platform is not available
     */
    boolean setCurrentPlatform(String k);

    /**
     * Add a possible hosting platform for this node with no platform specific options.
     * If it is the first added platform, it becomes the current hosting platform
     * If a platform with a same identifier is already in, there is no addition
     *
    ...
    /**
     * Add a possible hosting platform for this node with given options
     * If it is the first added platform, it becomes the current hosting platform
     * If a platform with a same identifier is already in, it is overriden
     *
     * @param id      the identifier of the platform
     ...
     *
     * @param p the platform identifier
     * @return a map of option if the platform is available on this node. {@code null} otherwise
     */
