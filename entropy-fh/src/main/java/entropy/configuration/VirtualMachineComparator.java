 ...
 */
public class VirtualMachineComparator implements Serializable, Comparator<VirtualMachine> {
    ...
    public VirtualMachineComparator(boolean asc, ResourcePicker.VMRc rc) {
        this.rcs = new LinkedList<ResourcePicker.VMRc>();
     ...
     *
     * @param vm1 The first element
     * @param vm2 The second element
