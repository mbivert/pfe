 ...
 */
public class BasicPlasmaVJob implements PlasmaVJob {
     ...
     */
    public BasicPlasmaVJob(String identifier) {
        this.id = identifier;
        this.constraints = new THashSet<PlacementConstraint>();
    ...
    public String toString() {
        ...
        for (Iterator<String> it = labels.iterator(); it.hasNext(); ) {
            ...
            b.append(ENDL);
            if (it.hasNext() || !constraints.isEmpty()) {
                b.append("\n");
            }
        }
