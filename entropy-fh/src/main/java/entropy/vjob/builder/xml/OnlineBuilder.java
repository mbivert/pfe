 ...
 */
public class OnlineBuilder implements XMLPlacementConstraintBuilder {
    ...
    @Override
    public Online buildConstraint(VJobElementBuilder eBuilder, List<Param> args) throws ConstraintBuilderException {
