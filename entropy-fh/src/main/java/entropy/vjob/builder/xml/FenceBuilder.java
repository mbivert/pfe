...
public class FenceBuilder implements XMLPlacementConstraintBuilder {
     ...
     */
    @Override
    public Fence buildConstraint(VJobElementBuilder eBuilder, List<Param> args) throws ConstraintBuilderException {
        ...
        ManagedElementSet<Node> ns = XMLPlacementConstraintBuilders.makeNodes(eBuilder, args.get(1));
