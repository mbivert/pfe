...
/**
 * A builder to make online constraints.
 *
 * @author Fabien Hermenier
 */
public class OnlineBuilder implements PBPlacementConstraintBuilder {
    ...
    @Override
    public Online buildConstraint(VJobElementBuilder eBuilder, List<PBVJob.vjob.Param> args) throws ConstraintBuilderException {
