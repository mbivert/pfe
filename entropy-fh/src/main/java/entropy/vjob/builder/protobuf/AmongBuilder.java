...
public class AmongBuilder implements PBPlacementConstraintBuilder {
     ...
     */
    @Override
    public PlacementConstraint buildConstraint(VJobElementBuilder eBuilder, List<PBVJob.vjob.Param> args) throws ConstraintBuilderException {
        ...
        Set<ManagedElementSet<Node>> nss = PBPlacementConstraintBuilders.makeNodesSet(eBuilder, args.get(1));
