 ...
 */
public final class ConstraintsCatalogBuilderFromProperties implements PBConstraintsCatalogBuilder {
    ...
    public PBConstraintsCatalog build() throws ConstraintsCalalogBuilderException {
        ...
        if (props.isDefined(CATALOG_CONTENTS_PROPERTIES)) {
            try {
                ...
                VJob.logger.debug("Available constraints for protobuf vjobs: " + c.getAvailableConstraints());
