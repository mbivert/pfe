...
public class TestSSHStop {
    ...
    public void testGetCommandToExecute() {
        Stop r = new Stop(new SimpleVirtualMachine("myVirtualMachine", 1, 2, 3), new SimpleNode("theSource", 1, 2, 3));
        try {
    ...
    public void testDefaultProperties() {
        Stop r = new Stop(new SimpleVirtualMachine("vm1", 1, 2, 3), new SimpleNode("n1", 1, 2, 3));
        try {
