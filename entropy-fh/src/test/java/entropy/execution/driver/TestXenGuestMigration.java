...
public class TestXenGuestMigration {
    ...
    public void testDefaultProperties() {
        try {
            XenGuestMigration m = new XenGuestMigration(new Migration(new SimpleVirtualMachine("vm1", 0, 0, 0),
                    new SimpleNode("n1", 0, 0, 0),
                    new SimpleNode("n2", 0, 0, 0)), TestHelper.readDefaultEntropyProperties());
