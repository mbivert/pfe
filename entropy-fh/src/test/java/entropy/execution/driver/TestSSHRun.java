...
public class TestSSHRun {
    ...
    public void testGetCommandToExecute() {
        Run r = new Run(new SimpleVirtualMachine("myVirtualMachine", 1, 2, 3), new SimpleNode("theSource", 1, 2, 3));
        try {
    ...
    public void testDefaultProperties() {
        Run r = new Run(new SimpleVirtualMachine("vm1", 1, 2, 3), new SimpleNode("n1", 1, 2, 3));
        try {
