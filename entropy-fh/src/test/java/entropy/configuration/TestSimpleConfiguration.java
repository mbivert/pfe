...
public class TestSimpleConfiguration {
    ...
    public void testVMCollision() {
        ...
        VirtualMachine vm1 = new SimpleVirtualMachine("VMa2697_id30300000b", 1, 1, 1);
        VirtualMachine vm2 = new SimpleVirtualMachine("VMa4141_id19400000", 1, 1, 1);
        cfg.addOnline(n1);
        cfg.addOnline(n2);
        cfg.setRunOn(vm1, n1);
        cfg.setRunOn(vm2, n2);
        Assert.assertEquals(cfg.getAllVirtualMachines().size(), 2);
