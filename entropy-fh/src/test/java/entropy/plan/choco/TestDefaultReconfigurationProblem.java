    ...
    public void testInstantiationWithNonViableConfiguration() throws PlanException {
        try {
            ...
            new DefaultReconfigurationProblem(src,
                    ...
                    dst.getOnlines(),
                    dst.getOfflines(),
                    new MockDurationEvaluator(7, 1, 2, 3, 4, 5, 6, 7, 8));
...
/*    @Test(expectedExceptions = {NoAvailableTransitionException.class})
    ...
    /**
     * Test the definition of the actions duration with custom boot and halt VM option.
     */
    public void testWithCustomVMBootAndHalt() {
        ...
        try {
            ...
            Assert.assertEquals(m.getAssociatedAction(vm1).getDuration().getInf(), 60);
            Assert.assertEquals(m.getAssociatedAction(vm2).getDuration().getInf(), 30);
            m.solve();
            Boolean ret = m.isFeasible();
            Assert.assertTrue(ret);
    ...
    public void testWithManageableNodes() {
        Configuration src = new SimpleConfiguration();
        Node n1 = new SimpleNode("N1", 3, 3, 3);
        Node n2 = new SimpleNode("N2", 3, 3, 3);
        src.addOnline(n1);
        ...
        try {
            ...
            Assert.assertEquals(m.getAssociatedAction(n2).getClass(), BootableNodeActionModel2.class);
        } catch (Exception e) {
            Assert.fail(e.getMessage(), e);
        }
    }
