...
public class TestFirstFitVJobScheduler {
    ...
    public void testValidAppend1() {
        ...
        try {
            ...
            PlasmaVJobBuilder b = new PlasmaVJobBuilder(new DefaultVJobElementBuilder(f), null);
    ...
    public void testCompute2() {
        ...
        try {
            ...
            PlasmaVJobBuilder b = new PlasmaVJobBuilder(new DefaultVJobElementBuilder(f), null);
            b.getElementBuilder().useConfiguration(c);
            PlasmaVJob l1 = b.build("leasee1", new File(RESOURCES_DIR + "lease1.txt"));
            PlasmaVJob l2 = b.build("leasee2", new File(RESOURCES_DIR + "lease2.txt"));
            PlasmaVJob l3 = b.build("leasee3", new File(RESOURCES_DIR + "lease3.txt"));
            q.add(l1);
            q.add(l2);
            q.add(l3);
            FirstFitVJobScheduler ff = new FirstFitVJobScheduler(q);
